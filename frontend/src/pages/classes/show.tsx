...
export default function ClassShow() {
  ...
  return (
    <PageShell
      ...
      actions={
        isAdmin ? (
          <Button size="sm" onClick={openAssignModal} className="gap-2 shrink-0">
          ...
          <Card className="border bg-card">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold">{classData.homeroom_teacher_name || "Belum Ditentukan"}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border bg-card">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold">{classData.student_count} Siswa</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border bg-card relative overflow-hidden">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-bold">{sppAmount !== null ? formatRp(sppAmount) : "Belum Diatur"}</p>
                {isAdmin && (
